...
if(isset($_POST['add']))
{
	...
	size='{$asize}', price='{$price}', location='{$loc}', city='{$city}', regions='{$regions}', feature='{$feature}',
	...
	totalfloor='{$totalfloor}', isFeatured='{$isFeatured}', payment='{$payment}' WHERE pid = {$pid}";
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="regions" required value="<?php echo $row['16']; ?>">
													</div>
												</div>
											</div>
											<div class="col-xl-6">
