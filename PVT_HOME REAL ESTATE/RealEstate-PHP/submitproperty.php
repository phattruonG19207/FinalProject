...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,regions,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor, isFeatured, payment)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$regions','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor', '$isFeatured', '$payment')";
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label"><b>Posting costs</b></label>
													<div class="col-lg-9">
										...
										<!-- <div class="row">
											<div class="col-md-6">
										<div class="form-group row">
													<label class="col-lg-3 col-form-label">Posting costs</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="payment" required placeholder="50000" readonly>
													</div>
												</div>
											</div>
										</div> -->
									
											<!-- <input type="submit" value="Submit Property" class="btn btn-danger"name="add" style="margin-left:200px;"> -->
											<!-- <form action="payment.php" method="POST">
											<input type="submit" value="Submit Property" onclick="window.location.href='payment.php'" class="btn btn-success" name="add" style="margin-left:200px;"></input>
										</form> -->
										<form action="payment.php" method="POST" id="vnPay">
										<!-- các trường input và button -->
										<input type="submit" value="Submit Property" class="btn btn-success" name="add" style="margin-left:200px;">
									</form>

									<script>
										// Gắn sự kiện onclick cho nút submit
										document.querySelector("#vnPay input[type='submit']").addEventListener("click", function(event) {
											// Ngăn chặn form tự động submit
											event.preventDefault();
											// Chuyển trang bằng cách gọi hàm submit()
											document.querySelector("#vnPay").submit();
