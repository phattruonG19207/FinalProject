...
<link href="assets/stylesheets/VR/normalize.css" rel="stylesheet" type="text/css" />  
<link href="assets/stylesheets/VR/swiper.min.css" rel="stylesheet" type="text/css" />  
<link href="assets/stylesheets/VR/styleVR.css" rel="stylesheet" type="text/css" />  
<!-- End of Core Stylesheet -->

<!--	Title
	=========================================================-->
<title>PVT-Home Real Estate PHP</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/pvth.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">WELLCOME TO</span><br>
                            PVT-HOME REAL ESTATE</h1>
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="price">
                                                ...
                                                <option value="11">$1,000,000 - $1,500,000</option>
                                                <option value="12">$1,500,000 - $2,000,000</option>
                                                <option value="13">$2,000,000 - $2,500,000</option>
                                                <option value="14">$2,500,000 - $3,000,000</option>
                                            </select>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    <button class="detail"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"> Property Detail</a></button>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="living-list pr-4">
                            <h3 class="pb-4 mb-3 text-white">PVT-Home where your trust is sent!</h3>
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>1. Intuitive and user-friendly design: PVT-Home has a beautiful interface that is easy to use and optimized for mobile devices.<br>
                                            2. Detailed real estate information: PVT-Home provides detailed information about properties, including descriptions, photos and prices so that users can make the best selection decision.<br>
                                            3. Advanced search feature: PVT-Home has an advanced search feature, allowing users to filter results by criteria such as price, area, location, type of real estate, utilities, .. .<br>
                                            4. Update information continuously: PVT-Home updates information about real estate and the real estate market continuously so that users can grasp market trends.<br>
                                            5. Reliability and credibility: PVT-Home ensures the accuracy and reliability of posted information and meets the standards of quality and safety of the service.<br>
                                            6. Professional staff: PVT-Home has a team of professional staff who enthusiastically support customers and answer customers' questions quickly.<br>
                                            7. Effective marketing strategy: PVT-Home has an effective marketing strategy, from offering attractive price policies to advertising and marketing to attract customers to use the service.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> 1. Ease of use: PVT-Home is easy to use, users can find information easily.</br>
                                            2. Speed: PVT-Home can operate quickly and respond to customers' needs efficiently.</br>
                                            3. Features: PVT-Home has all necessary features and meets the needs of customers.</br>
                                            4. Aesthetics: PVT-Home has a beautiful design and attracts users.</br>
                                            5.Interaction: Customers can interact with PVT-Home conveniently.</br>
                                            6. Support: PVT-Home provides high-quality support to help customers resolve issues that arise.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Optimize the working process of agents and attract more customers. Increase productivity in search processes, update appointment management, solve technical problems, and especially increase competition with other agents.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> 1. Price: Buyer and seller must agree on a price before the contract is executed.<br>
                                2. Expenses involved: In addition to selling or buying real estate, there are also many other costs incurred such as taxes, insurance premiums and other fees.<br>
                                3. Attached Appendix: Warranty terms, warranty policy, insurance and purpose of use.<br>
                                4. Payment Deadline: We need to consider PAYMENTS, contributions, deadlines and financial system.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> 1. Right to use real estate: The right to use real estate must be clearly stated in the real estate purchase and sale contract. The word use right is the use of real estate for what or for whom.<br>
                                2. Human rights: The real estate sale and purchase contract must clearly confirm the identity of the purchaser, such as name, date of birth, address, etc.<br>
                                3. Real estate value: The transaction value must be clearly stated in the real estate sale and purchase contract.<br>
                                4. Payment term: The buyer is responsible for the payment within the agreed term.<br>
                                5. Legal rights related to the contract: The real estate sale and purchase contract must comply with the legal documents on real estate of Vietnam.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> 1. Analyze and understand the terms of the contract.<br>
                                2. To perform the obligations committed in the contract.<br>
                                3. Maintain communication and exchange with the third party linked by the contract.<br>
                                4. Make sure the contract elements are still valid at the time of transaction.<br>
                                5. Protect your legal rights throughout the contract completion process.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(regions), property.* FROM property where city='Olisphis'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['regions'];?></a></h4>
                                    <span><?php 
												$total = $row[0];
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(regions), property.* FROM property where city='Awrerton'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['regions'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(regions), property.* FROM property where city='Floson'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['regions'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(regions), property.* FROM property where city='Ulmore'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['regions'];?></a></h4>
...
<!-- Start of Library Script Tags -->
<script src="assets/scripts/VR/webgl-utils.min.js"></script>
<script src="assets/scripts/VR/three.min.js"></script>
<script src="assets/scripts/VR/aframe-v0.9.2.js"></script>
<!-- End of Library Script Tags -->
