  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/PVTHome.png" alt="Logo" width="50px" height="50px">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/PVTHome.png" alt="Logo" width="50" height="50">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown app-dropdown">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="assets/img/profiles/avata-02.png" width="31" alt="Ryan Taylor"></span>
						</a>
