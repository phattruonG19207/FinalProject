							...
							if(isset($_REQUEST['filter']))
							{
                                ...
                                switch($price){
                                    ...
                                    case "14":
                                        ...
                                        break;
                                    default:
                                        // Invalid price range selected, do nothing
                                }
								$city=$_REQUEST['city'];
                                
								
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}' and stype='{$stype}' and price='{$price}' and city='{$city}'";
                                $sql = "SELECT * FROM property WHERE price >= $min_price AND price <= $max_price";
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-4">
                                                    ...
                                                    <div><?php echo $row['13'];?></div></span> </div>
                                                </div>
                                                <div class="px-4 pb-4 d-inline-block w-100">
                                                    <div class="float-left text-capitalize"><i class="fas fa-user text-success mr-1"></i>By : <?php echo $row['1'];?></div>
